Menu["Menu for the X Front End",
{
	Menu["File",
	{
		...
		Delimiter
        (*MenuItem["&Quit",KernelExecute[runShortcut["ctrl_q_.m"]], MenuEvaluator -> Automatic , MenuKey["q", Modifiers->{"Control","Shift"}]]*)
	}],
	Menu["&Edit",
	{
		MenuItem["&Undo", "Undo", MenuKey["/", Modifiers->{"Control"}]],
		MenuItem["Re&do", "Redo", MenuKey["/", Modifiers->{"Control", "Shift"}]],
		Delimiter,
		(*MenuItem["Cu&t", "Cut", MenuKey["w", Modifiers->{"Control"}]],*)
		...
		MenuItem["Un/C&omment Selection", KernelExecute[FE`toggleComment[]], MenuKey[";", Modifiers->{"Control"}], MenuEvaluator -> "System", Method -> "Queued"],
		Delimiter,
		...
		MenuItem["Chec&k Spelling...", "FindNextMisspelling", MenuKey["'", Modifiers->{"Control","Command","Alt"}]],
		Delimiter,
...
(*		MenuItem["Find Next Re&d", "FindNextWarningColor"],*)
	...
	Menu["&Insert",
	{
		...
		Menu["&Typesetting",
		{
			...
			Delimiter,
			MenuItem["&Fraction", "Fraction", MenuKey["/", Modifiers->{ "Command"}]],
		...
		Menu["Table/Matrix",
		{
			...
			Delimiter,
			MenuItem["Add &Row", "NewRow", MenuKey["o", Modifiers->{"Command"}]],
			MenuItem["Add &Column", "NewColumn", MenuKey["k", Modifiers->{"Command"}]],
			Delimiter,
	...
	Menu["Fo&rmat",
	{
		...
		Menu["Fa&ce",
		{
			...
			ToggleMenuItem["&Bold", FontWeight->Toggle , MenuKey["b", Modifiers->{"Control","Shift"}] ],
			ToggleMenuItem["&Italic", FontSlant->Toggle, MenuKey["i", Modifiers->{"Control","Shift"}]],
			ToggleMenuItem["&Underline", FrontEnd`FontVariationsUnderline->Toggle, MenuKey["u", Modifiers->{"Control","Shift"}]]
		}],
		Menu["Si&ze",
		{
		...
		Menu["Te&xt Color",
		{
			...
			Delimiter,
			LinkedItems[{
				MenuItem["Black",	FontColor->GrayLevel[0],MenuKey["B", Modifiers->{"Command","Alt", "Shift"}]],
				MenuItem["Gray",	FontColor->GrayLevel[0.5]],
				MenuItem["White",	FontColor->GrayLevel[1]],
				Delimiter,
				MenuItem["Blue",	FontColor->RGBColor[0, 0, 1], MenuKey["B", Modifiers->{"Command","Option", "Shift"}]],
				...
				MenuItem["Red",		FontColor->RGBColor[1, 0, 0], MenuKey["R", Modifiers->{"Command","Option", "Shift"}]],
	...
	Menu["Evaluation",
	{
		MenuItem["Spea&k Selection", "SelectionSpeak", MenuKey["Return", Modifiers->{"Control"}]],
		...
		Delimiter,
		MenuItem["Evaluate N&otebook", "EvaluateNotebook",MenuKey["z", Modifiers->{"Control"}]],
		...
		Menu["&Quit Kernel",
		{
			MenuItem["First Quit Kernel", "MenuListQuitEvaluators", MenuAnchor->True, MenuEvaluator -> Automatic , MenuKey["F1", Modifiers->{"Control"}]],
            MenuItem["First Quit Kernel", "MenuListQuitEvaluators",  MenuKey["F2", Modifiers->{"Control"}]]
		}]
	}],
	Menu["&Palettes",
	{
